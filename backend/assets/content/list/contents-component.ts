...
class SearchBox implements ChangeAware, Component<string|null> {
    ...
    public constructor(
        ...
        this.contentQueryFields.onChange(async (isFilterChange: boolean): Promise<void> => {
            ...
            try {
                ...
                const searchTerm = this.contentQueryFields.searchBox.getValue();
                this.contentsList.show(paginatedContents.list, searchTerm);
