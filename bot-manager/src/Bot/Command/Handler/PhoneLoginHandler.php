...
#[HandlesCommand(PhoneLoginCommand::class)]
final readonly class PhoneLoginHandler implements CommandHandler
{
    ...
    {
        PhoneLoginCommand::validate($command, $this->statusManager->status());

        $this->processManager->start(Process::PhoneLogin);
    }
}
